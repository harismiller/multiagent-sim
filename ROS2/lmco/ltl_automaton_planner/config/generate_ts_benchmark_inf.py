...
block_start = [(c1_start+1,c1_start),(c1_end,c1_start),(c1_start+1,c1_end),(c1_start,c1_start+1)]
block_end = [(c1_end,c1_start),(c1_end,c1_end-1),(c1_end-1,c1_end),(c1_start,c1_end-1)]
...
with open('benchmark_block_'+str(N)+'_inf.yaml', 'w') as file:
...
bump_start = [(c1_start,c1_start),(c1_start,c1_start),  (c1_start,c1_end),  (c1_start,c1_end),  (c1_end,c1_end+1),(c1_end+1,c1_end)]
bump_end = [(c1_start-1,c1_start),(c1_start,c1_start-1),(c1_start,c1_end+1),(c1_start-1,c1_end),  (c1_end,c1_end),  (c1_end,c1_end)]
...
count = 0
pairs = []
for k in range(len(bump_start)):

    pairs.append([list(bump_start[k]), list(bump_end[k])])
data_bumps['bumps']['points'] = pairs

with open('benchmark_bump_'+str(N)+'_inf.yaml', 'w') as file:
